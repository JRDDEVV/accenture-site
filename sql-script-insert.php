...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>SQL</title>
    <link rel="stylesheet" href="styles\main.cssmain.css">
  ...
  <body style="background-color: rgb(250, 250, 250);">
    ...
    <main class="container shadow-sm " style="margin-top:2%; background-color: white; border-radius:10px; padding:2%;">
      ...
      <hr>
      <!-- Calls the 'insertIntoDatabase();' function, this takes the values entered by the user on the 'sql-page.php' file and inserts them into the database. -->
      <?php
