...
<html lang="en">
  ...
  <body style="background-color: rgb(250, 250, 250);">
    ...
    <main class="container shadow-sm " style="margin-top:2%; background-color: white; border-radius:10px; padding:2%;">
      ...
      <h1> If statement result </h1>
      <hr>
      <p>You set the first value to: <?php echo $_POST["ifValue1"]; ?></p>
      <p>You set the second value to: <?php echo $_POST["ifValue2"]; ?> </p>
      <hr>
      <!-- Calls the 'compareValues();' function and passes through the values 'ifValue1' and 'ifValue2'. -->
      <?php
      ...
      <br>
      <figcaption class="blockquote-footer">Click <cite title="Source Title"><a href="conditional.php">Here</a></cite> to return to previous page</figcaption>
