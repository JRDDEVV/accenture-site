...
<html lang="en">
  ...
  <body style="background-color: rgb(250, 250, 250);">
    ...
    <main class="container shadow-sm " style="margin-top:2%; background-color: white; border-radius:10px; padding:2%;">
      ...
      <h1><p>Arrays</p></h1>
      <p>Arrays can be used to store various pieces of data and information. PHP is very useful in that it can store multiple different types of data in an array, ranging from number values, strings and even entire functions.</p>
      <p>There are a range of different array types, such as multidimensional arrays. However, below you can access a simple one dimensional array and enter information.</p>
      <hr>
      <!-- Calls the 'arrays-script.php' file and passes through the 'arrayEntries' value which is later parsed by the 'textSeperator();' function using a comma ',' as the parsing parameter. -->
      <form action="arrays-script.php" method="POST">
        <p>Try out populating an array for yourself below. Be sure to seperate array entries using a comma ',' this allows the functionality in the backend to seperate the array entries. </p>
        <p>Array Name = array( <input type="text" name="arrayEntries" placeholder="Array values go here" value=""> ); <input type="submit" value="Populate Array" class="btn btn-primary"></p>
      </form>
