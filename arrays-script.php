...
<html lang="en">
  ...
  <body style="background-color: rgb(250, 250, 250);">
    ...
    <main class="container shadow-sm " style="margin-top:2%; background-color: white; border-radius:10px; padding:2%;">
      ...
      <hr>
      <br>
      <figcaption class="blockquote-footer">Click <cite title="Source Title"><a href="arrays.php">Here</a></cite> to return to previous page</figcaption>
      <!-- Calls the 'textSeperator();' function from the 'functions.php' file. This passes through the 'arrayEntries' value from 'arrays.php' to be parsed by the function. -->
      <?php
