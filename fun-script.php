...
<html lang="en">
  ...
  <body style="background-color: rgb(250, 250, 250);">
    ...
    <main class="container shadow-sm " style="margin-top:2%; background-color: white; border-radius:10px; padding:2%;">
      ...
      <h1><p>Function output</p></h1>
      <p>Below you can see the output of the function previously executed.</p>
      <hr>
      <!-- This calls the 'generateHTML();' function and passes through the 'openAttri' , 'funcText' and 'closeAttri' values. -->
      <?php
      ...
      <br>
      <figcaption class="blockquote-footer">Click <cite title="Source Title"><a href="fun.php">Here</a></cite> to return to previous page</figcaption>
