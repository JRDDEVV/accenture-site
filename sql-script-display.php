...
<html lang="en">
  ...
  <body style="background-color: rgb(250, 250, 250);">
    ...
    <main class="container shadow-sm " style="margin-top:2%; background-color: white; border-radius:10px; padding:2%;">
      ...
      <h1> Display Database Information</h1>
      <hr>
      <br>
      <figcaption class="blockquote-footer">Click <cite title="Source Title"><a href="sql-page.php">Here</a></cite> to return to previous page</figcaption>
      <hr>
      <!-- Calls the 'displayUserInfo();' function, this causes the current records in the database table to be displayed. Selected records can be chosen within this function in the 'functions.php' file. -->
      <?php
